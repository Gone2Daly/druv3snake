...
class Snake:
    ...
    def step(self, action):
        ...
        if ((action == 0 or action == 2) and self.current_direction_index == 0) or ((action == 0 or action == 2) and self.current_direction_index == 2) or ((action == 1 or action == 3) and self.current_direction_index == 1) or ((action == 1 or action == 3) and self.current_direction_index == 3):
            self.current_direction_index = self.current_direction_index
        else:
